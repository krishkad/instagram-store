  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
        ...
        <p className="text-xl md:text-2xl mb-4 animate-fade-in opacity-90" style={{ animationDelay: '0.2s' }}>
          Shop Now in Style
        </p>
        <p className="text-lg mb-8 animate-fade-in opacity-80 max-w-2xl mx-auto leading-relaxed" style={{ animationDelay: '0.4s' }}>
          Discover our curated collection of luxury fashion and lifestyle pieces, 
          handpicked with love and trusted by thousands of Instagram shoppers.
        </p>
